...
[compare]: https://github.com/conda/conda-self/compare
[new release]: https://github.com/conda/conda-self/releases/new
...
[Anaconda Recipes]: https://github.com/AnacondaRecipes/conda-self-feedstock
[conda-forge]: https://github.com/conda-forge/conda-self-feedstock
...
Placeholder for `conda-self MAJOR.MINOR.PATCH` release.
...
[milestone]: https://github.com/conda/conda-self/milestone/<milestone>
[process]: https://github.com/conda/conda-self/blob/main/RELEASE.md
[releases]: https://github.com/conda/conda-self/releases
[main]: https://github.com/AnacondaRecipes/conda-self-feedstock
[conda-forge]: https://github.com/conda-forge/conda-self-feedstock
[zulip]: https://conda.zulipchat.com/#narrow/channel/480811-releases
...
1. Clone and `cd` into the repository if you haven't done so already:
    ...
    ```bash
    $ git clone git@github.com:/conda-self.git
    $ cd conda-self
    ```
